...
const config: DocsThemeConfig = {
  project: {
    link: 'https://github.com/JHSeo-git/practice-storybook-vite',
  },
  docsRepositoryBase: 'https://github.com/JHSeo-git/practice-storybook-vite/tree/main/docs',
  useNextSeoProps() {
  ...
  head: function useHead() {
    ...
    const socialCard = 'https://practice-design-system-nextra.vercel.app/og-image.png';

    return (
      <>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta httpEquiv="Content-Language" content="ko" />
        <meta name="description" content="Practice Design System Document" />
        <meta name="og:description" content="Practice Design System Document." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content={socialCard} />
        <meta name="twitter:site:domain" content="practice-design-system-nextra.vercel.app" />
        <meta name="twitter:url" content="https://practice-design-system-nextra.vercel.app" />
